...
public class NukeModule extends Module {
    ...
    private static final double MAX_REACH    = 9.0; // conservative, server uses 10
    private static final long   MS_PER_BREAK = 220; // ~4.5/sec
    ...
    public void onTick() {
        ...
        // Find next reachable solid block
        int checked = 0;
